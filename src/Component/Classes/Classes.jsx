		...
		<div className="container mx-auto">
			<div className="text-center my-4 ">
				...
				<p className="text-xl font-serif font-semibold text-green-400 my-2">
					Our Famous instructors, class just for you.
				</p>
						...
						<div className="container bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out ">
							...
							<div className="">
								<div className="px-7 mb-4">
									<h2 className="text-2xl flex items-center   pt-0 mt-0 mb-2 font-bold text-green-800 dark:text-gray-300">
										<GiTeacher className="text-green-500 h-4 w-10"></GiTeacher>{" "}
										{instructor.name}
									</h2>
									<p className="flex items-center  text-gray-500 mt-2 dark:text-gray-400">
										<SiGoogleclassroom className="text-green-500 h-4 w-10"></SiGoogleclassroom>{" "}
									...
									>
										<MdEventAvailable className="text-green-500 h-5 w-10" />
										{instructor.availableSeats} Available Seat
									</p>
									...
									<p className="mt-2 text-justify  text-gray-600 dark:text-gray-300">
										This photography class will take you to an advanced level in
										no time and fill any gaps of knowledge that may be causing
										you not to reach your full potential.
									</p>
									<button
									...
									<div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
										<button className=" text-sky-400 hover:text-green-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
											<svg
										...
										<button className=" text-rose-400 hover:text-green-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
											<svg
												className="w-7 h-7 fill-current"
												role="img"
												viewBox="0 0 24 24"
										...
										<button className=" text-red-600 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
											<svg
												className="w-7 h-7 fill-current"
												role="img"
												viewBox="0 0 24 24"
										...
										<button className=" text-blue-700 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
											<svg
												className="w-7 h-7 fill-current"
												role="img"
												viewBox="0 0 256 256"
										...
										<button className=" text-red-700 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:text-gray-400 dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
											<svg
												className="w-7 h-7 fill-current"
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 16 16"
